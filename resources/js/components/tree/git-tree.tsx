    ...
    useEffect(() => {
        ...
        const graphNodes: GraphNode[] = [
            // Main branch (vertical line on the left)
            {
                ...
                x: 10,
                y: 5,
                connections: [{ target: '2', type: 'straight' }],
                active: false,
            },
            {
                id: '2',
                ...
                x: 10,
                y: 15,
                connections: [{ target: '3', type: 'straight' }],
                active: false,
            },
            {
                id: '3',
            ...
            },
            {
                ...
                x: 10,
                y: 35,
                connections: [{ target: '8', type: 'straight' }],
                active: false,
            },
            ...
            // Feature branch 1 (extends right only)
            {
                ...
                x: 30,
                y: 25,
                connections: [{ target: '6', type: 'straight' }],
                active: false,
            },
            {
                id: '6',
                ...
                x: 50,
                y: 25,
                connections: [{ target: '7', type: 'straight' }],
                active: false,
            },
            ...
            },
            {
                ...
                x: 10,
                y: 55,
                connections: [{ target: '10', type: 'straight' }],
                active: false,
            },
            {
                id: '10',
                ...
                x: 10,
                y: 65,
                connections: [{ target: '11', type: 'straight' }],
                active: false,
            },
            {
                id: '11',
            ...
            // Hotfix branch (extends right only)
            {
                ...
                x: 30,
                y: 45,
                connections: [{ target: '13', type: 'straight' }],
                active: false,
            },
            {
                id: '13',
                ...
                x: 50,
                y: 45,
                connections: [{ target: '14', type: 'straight' }],
                active: false,
            },
            {
                id: '14',
                ...
                x: 70,
                y: 45,
                connections: [{ target: '15', type: 'straight' }],
                active: false,
            },
            ...
            // Main branch continued
            {
                ...
                x: 10,
                y: 85,
                connections: [{ target: '17', type: 'branch' }],
                active: false,
            },
            ...
            // Release branch (extends right only)
            {
                ...
                x: 30,
                y: 85,
                connections: [{ target: '18', type: 'straight' }],
                active: false,
            },
            {
                id: '18',
                ...
                x: 50,
                y: 85,
                connections: [{ target: '19', type: 'straight' }],
                active: false,
            },
            {
                id: '19',
                ...
                x: 70,
                y: 85,
                connections: [{ target: '20', type: 'straight' }],
                active: false,
            },
    ...
    useEffect(() => {
        ...
        const animateGraph = async () => {
            ...
            for (let i = 0; i < nodes.length; i++) {
                ...
                setNodes((prev) =>
                    prev.map((node, index) => (index === i ? { ...node, active: true } : node))
                );
    ...
    return (
        <div className="mx-auto w-full max-w-4xl">
            ...
            >
                ...
                <div className="pointer-events-none absolute inset-0 grid grid-cols-10 grid-rows-10 opacity-5">
                    ...
                    <svg className="absolute inset-0 h-full w-full">
                        ...
                        {nodes.map((node) =>
                            node.connections.map((connection) => {
                                ...
                                const needsAngle =
                                    node.x !== targetNode.x && node.y !== targetNode.y;
