    ...
    return (
        <>
            ...
            <div className="flex min-h-screen flex-col bg-black text-white">
                ...
                {/* Hero section */}
                <section className="mt-16 flex min-h-screen flex-col items-center justify-center px-6 pt-12 pb-20 lg:px-8 lg:pt-20 lg:pb-32">
                    <div className="relative mx-auto max-w-7xl">
                        ...
                        <div className="absolute inset-0 -z-10 h-full w-full overflow-hidden">
                            <div className="absolute top-1/4 -right-1/4 h-64 w-64 rounded-full bg-violet-500/20 blur-3xl"></div>
                            <div className="absolute bottom-1/4 -left-1/4 h-64 w-64 rounded-full bg-indigo-500/20 blur-3xl"></div>
                        </div>
                        ...
                        <div className="flex flex-col items-center text-center">
                            ...
                            <p className="mt-6 max-w-2xl text-lg text-neutral-400">
                                Track your learning journey, set goals, and visualize your progress
                                with our intuitive skill tree system.
                            </p>
                            ...
                            <div className="mt-16 grid grid-cols-3 gap-8 opacity-70 lg:grid-cols-3">
                                <div className="flex items-center justify-center text-lg font-semibold tracking-tight text-neutral-400">
                                    runway
                                </div>
                                <div className="flex items-center justify-center text-lg font-semibold tracking-tight text-neutral-400">
                                    leonardo.ai
                ...
                <section
                    id="features"
                    className="border-t border-neutral-800 px-6 py-20 lg:px-8 lg:py-32"
                >
                    <div className="mx-auto max-w-7xl">
                        <div className="mx-auto max-w-3xl text-center">
                            ...
                            <p className="mt-4 text-lg text-neutral-400">
                                Our skill tree system is designed to make learning structured,
                        ...
                        <div className="mt-16 grid gap-8 md:grid-cols-3">
                            ...
                            <div className="group rounded-xl border border-neutral-800 bg-neutral-900/50 p-8 transition-all hover:border-neutral-700 hover:bg-neutral-900">
                                ...
                                <p className="mt-2 text-neutral-400">
                                    See your skills as an interactive tree, making it easy to track
                                    progress and identify growth areas.
                                </p>
                            </div>
                            ...
                            <div className="group rounded-xl border border-neutral-800 bg-neutral-900/50 p-8 transition-all hover:border-neutral-700 hover:bg-neutral-900">
                                <div className="mb-5 inline-flex h-12 w-12 items-center justify-center rounded-lg bg-indigo-500/10 text-indigo-400">
                                    ...
                                    >
                                        <path
                                            d="M11 3H7C5.89543 3 5 3.89543 5 5V19C5 20.1046 5.89543 21 7 21H17C18.1046 21 19 20.1046 19 19V15M19 11V5C19 3.89543 18.1046 3 17 3H15M9 7H15M9 11H11M9 15H9.01M13 15L15.5 12.5M17.5 14.5L15 12"
                                            stroke="currentColor"
                                            strokeWidth="2"
                                            strokeLinecap="round"
                                            strokeLinejoin="round"
                                ...
                                <p className="mt-2 text-neutral-400">
                                    Follow clear learning paths with prerequisites and skill
                            ...
                            <div className="group rounded-xl border border-neutral-800 bg-neutral-900/50 p-8 transition-all hover:border-neutral-700 hover:bg-neutral-900">
                                <div className="mb-5 inline-flex h-12 w-12 items-center justify-center rounded-lg bg-blue-500/10 text-blue-400">
                                    ...
                                    >
                                        <path
                                            d="M15 10L20 10M20 10L18 8M20 10L18 12M8 14H3M3 14L5 12M3 14L5 16M12 3V21M12 3L9 5M12 3L15 5M12 21L9 19M12 21L15 19"
                                            stroke="currentColor"
                                            strokeWidth="2"
                                            strokeLinecap="round"
                                            strokeLinejoin="round"
                                ...
                                <p className="mt-2 text-neutral-400">
                                    Set measurable learning goals and track your progress toward
                                    achieving them.
                                </p>
                            </div>
                        </div>
                ...
                <section
                    id="method"
                    className="relative border-t border-neutral-800 px-6 py-20 lg:px-8 lg:py-32"
                >
                    <div className="relative mx-auto max-w-7xl">
                        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
                            <div>
                                ...
                                <p className="mt-4 text-lg text-neutral-400">
                                    Our approach is based on proven learning methodologies that
                                ...
                                <div className="mt-8 space-y-6">
                                    <div className="group flex items-start gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="mt-1 text-neutral-400">
                                                Identify the core components that make up your
                                                target skill.
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="group flex items-start gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="mt-1 text-neutral-400">
                                                Create a pathway of progressive skill development
                                    ...
                                    <div className="group flex items-start gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="mt-1 text-neutral-400">
                                                Track your progress and adjust your learning
                                                approach as needed.
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div className="flex h-full flex-col">
                                    ...
                                    <div className="flex-1 rounded-lg bg-black/60 p-4 font-mono text-sm">
                                        <p className="text-neutral-500">
                                            // Example skill acquisition flow
                                        </p>
                                        <p className="text-blue-400">
                                            function{' '}
                                            <span className="text-violet-400">trackProgress</span>
                                            (skill) {'{'}
                                        </p>
                                        <p className="ml-4 text-neutral-300">
                                            const <span className="text-indigo-400">subSkills</span>{' '}
                                            = breakDown(skill);
                                        </p>
                                        <p className="ml-4 text-neutral-300">
                                            const{' '}
                                            <span className="text-indigo-400">milestones</span> =
                                            setMilestones(subSkills);
                                        </p>
                                        <p className="ml-4 text-neutral-300">
                                            return measureProgress(milestones);
                                        </p>
                ...
                <section className="relative border-t border-neutral-800 px-6 py-20 lg:px-8 lg:py-32">
                    <div className="absolute inset-0 overflow-hidden">
                        <div className="absolute top-1/2 left-1/2 h-96 w-96 -translate-x-1/2 -translate-y-1/2 rounded-full bg-gradient-to-b from-violet-500/20 to-indigo-500/10 blur-3xl"></div>
                    </div>
                    <div className="relative mx-auto max-w-7xl">
                        <div className="mx-auto max-w-3xl text-center">
                            <h2 className="text-3xl font-bold tracking-tight text-white lg:text-4xl">
                            ...
                            <p className="mt-4 text-lg text-neutral-400">
                                Start your learning journey today with our structured skill tree
                                approach.
                            </p>
            ...
            <style jsx global>{`
                ...
                .git-node:nth-child(2) {
                    --index: 0;
                }
                .git-node:nth-child(3) {
                    --index: 1;
                }
                .git-node:nth-child(4) {
                    --index: 2;
                }
                .git-node:nth-child(5) {
                    --index: 3;
                }
                .git-node:nth-child(6) {
                    --index: 4;
                }

                .git-node:nth-child(13) {
                    --index: 5;
                }
                .git-node:nth-child(14) {
                    --index: 6;
                }
                .git-node:nth-child(15) {
                    --index: 7;
                }
                .git-node:nth-child(16) {
                    --index: 8;
                }
                .git-node:nth-child(17) {
                    --index: 9;
                }
                .git-node:nth-child(18) {
                    --index: 10;
                }

                .git-node:nth-child(23) {
                    --index: 11;
                }
                .git-node:nth-child(24) {
                    --index: 12;
                }
                .git-node:nth-child(25) {
                    --index: 13;
                }
                .git-node:nth-child(26) {
                    --index: 14;
                }

                /* Branch animation timing */
                .git-branch:nth-child(1) {
                    animation-delay: 0.1s;
                }

                /* Horizontal branches */
                .git-branch:nth-child(7) {
                    animation-delay: 0.6s;
                }
                .git-branch:nth-child(8) {
                    animation-delay: 1s;
                }
                .git-branch:nth-child(9) {
                    animation-delay: 1.4s;
                }
                .git-branch:nth-child(10) {
                    animation-delay: 0.8s;
                }
                .git-branch:nth-child(11) {
                    animation-delay: 1.2s;
                }
                .git-branch:nth-child(12) {
                    animation-delay: 1.6s;
                }

                /* Vertical branches */
                .git-branch:nth-child(13) {
                    animation-delay: 1.2s;
                }
                .git-branch:nth-child(14) {
                    animation-delay: 1.6s;
                }
                .git-branch:nth-child(15) {
                    animation-delay: 1.4s;
                }
                .git-branch:nth-child(16) {
                    animation-delay: 1.8s;
                }

                /* Cross branches */
                .git-branch:nth-child(17) {
                    animation-delay: 1.8s;
                }
                .git-branch:nth-child(18) {
                    animation-delay: 2.2s;
                }
                .git-branch:nth-child(19) {
                    animation-delay: 2s;
                }
                .git-branch:nth-child(20) {
